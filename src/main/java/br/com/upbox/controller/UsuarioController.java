...
public class UsuarioController {
    ...
    public ModelAndView enviaUsuario(@ModelAttribute("usuario") Usuario usuario) {
        String usuarioComoString = UsuarioControllerUtil.preparaJsonString(usuario);
        UsuarioControllerUtil.enviaUsuario(usuarioComoString);
    ...
    public ModelAndView removerUsuario(@ModelAttribute("usuario") Usuario usuario) {
        ...
        String usuarioComoString = UsuarioControllerUtil.preparaJsonString(usuario);
        Usuario usuarioRetornado = UsuarioControllerUtil.deletaUsuario(usuarioComoString);
...
//        Set<BasicDBObject> set = UsuarioControllerUtil.lista(username);
